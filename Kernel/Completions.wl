...
BeginPackage["KirillBelov`AILink`Completions`", {
    "KirillBelov`Objects`", 
...
Module[{endpoint, apiKey, requestAssoc, requestBody, path, url}, 
    ...
    Global`$request = HTTPRequest[url, <|
        Method -> "POST", 
